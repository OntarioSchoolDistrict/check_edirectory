...
Monitoring plugin to check eDirectory using ndsrepair and ndsstat.
...
For the -P check, the plugin only considers lines that start with `.CN=` as replica entries, ensuring accurate detection of replica states.
